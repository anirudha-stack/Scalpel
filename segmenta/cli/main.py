...
from segmenta import Segmenta, SegmentaConfig, __version__
from segmenta.exceptions import SegmentaError
...
def cli(
    ...
    console.print(
        Panel.fit(
            f"[bold blue]Segmenta v{__version__}[/bold blue]\n"
