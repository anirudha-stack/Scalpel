...
from scalpel import Scalpel, ScalpelConfig, __version__
from scalpel.exceptions import ScalpelError
...
def cli(
    ...
    console.print(
        Panel.fit(
            f"[bold blue]Scalpel v{__version__}[/bold blue]\n"
